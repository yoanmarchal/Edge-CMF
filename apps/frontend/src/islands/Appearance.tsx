...
export default function Appearance() {
  ...
  useEffect(() => {
    adminApi
      .get<{ data: { value: string | null } }>(`/api/admin/settings?key=${THEME_SETTING_KEY}`)
  ...
  const activate = async (id: string) => {
    ...
    setError(null);
    try {
      await adminApi.put('/api/admin/settings', { key: THEME_SETTING_KEY, value: id });
      setActive(id);
    } catch (e) {
  ...
  return (
    <>
      ...
      <p class="muted">
        ...
        <code>public/themes/base/theme.css</code>), les autres thèmes ne redéfinissent que ce qu'ils changent
        (<code>@layer theme-override</code>) — aucune surcharge à l'aveugle.
      </p>
